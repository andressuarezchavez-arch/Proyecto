    ...
    <div className="min-h-screen bg-gray-100 text-gray-900">
      ...
      <header className="bg-blue-600 text-white shadow-lg">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
          <div>
            ...
            <p className="text-sm opacity-90">Servicios técnicos rápidos y confiables</p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="text-lg text-gray-600 mb-8">
            Solicita servicios de computadoras, electricidad, plomería,
            cámaras de seguridad, limpieza y más desde una sola plataforma.
          </p>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8">
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-blue-50 rounded-2xl p-5">
              <h3 className="font-bold text-lg mb-2">💻 Técnicos PC</h3>
              <p className="text-gray-600 text-sm">Reparación, formateo y mantenimiento.</p>
            </div>

            <div className="bg-yellow-50 rounded-2xl p-5">
              <h3 className="font-bold text-lg mb-2">⚡ Electricistas</h3>
              <p className="text-gray-600 text-sm">Instalaciones y reparaciones eléctricas.</p>
            </div>

            <div className="bg-green-50 rounded-2xl p-5">
              <h3 className="font-bold text-lg mb-2">🚿 Plomeros</h3>
              <p className="text-gray-600 text-sm">Soluciones rápidas para tu hogar.</p>
            </div>

            <div className="bg-purple-50 rounded-2xl p-5">
              <h3 className="font-bold text-lg mb-2">📷 Cámaras</h3>
              <p className="text-gray-600 text-sm">Instalación de seguridad y monitoreo.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 py-10">
        <div className="flex justify-between items-center mb-8">
          <h2 className="text-3xl font-bold">Técnicos destacados</h2>
          <button className="text-blue-600 font-semibold">Ver todos</button>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {technicians.map((tech, index) => (
            <div
              key={index}
              className="bg-white rounded-3xl shadow-lg p-6 hover:-translate-y-1 transition"
            >
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  <h3 className="font-bold text-xl">{tech.name}</h3>
                  <p className="text-gray-500 text-sm">{tech.specialty}</p>
                </div>
              </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="bg-white rounded-3xl shadow-xl p-8 grid md:grid-cols-2 gap-10">
          <div>
            <h2 className="text-3xl font-bold mb-6">Solicita un servicio</h2>
      ...
      <footer className="bg-gray-900 text-white mt-20">
        <div className="max-w-7xl mx-auto px-6 py-10 grid md:grid-cols-3 gap-8">
          <div>
            <h2 className="text-2xl font-bold mb-3">TecniYa</h2>
